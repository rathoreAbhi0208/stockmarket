...
from strategies import evaluate_conditions
...
def read_root():
    return {
        ...
        "endpoints": {
            ...
            "/custom_strategy": "POST - Build and test custom strategy",
...
# ============================================================================
# Custom Strategy Builder Endpoint
# ============================================================================

@app.post("/custom_strategy")
def build_custom_strategy(request: StrategyRequest):
    """
    Build and evaluate a custom trading strategy with user-defined conditions
